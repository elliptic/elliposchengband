...
static _effect_info_t _effect_info[] =
{
    ...
    {"CLAIRVOYANCE",    EFFECT_CLAIRVOYANCE,        35, 100,  8, BIAS_MAGE | BIAS_POWER},
    ...
    {"DIMENSION_DOOR",  EFFECT_DIMENSION_DOOR,      50, 100,  8, BIAS_MAGE | BIAS_ARCHER | BIAS_POWER},
    ...
    {"DESTRUCTION",     EFFECT_DESTRUCTION,         50, 250,  6, BIAS_DEMON | BIAS_POWER},
    {"GENOCIDE",        EFFECT_GENOCIDE,            70, 500, 16, BIAS_NECROMANTIC | BIAS_POWER},
    {"MASS_GENOCIDE",   EFFECT_MASS_GENOCIDE,       80, 750, 16, BIAS_NECROMANTIC | BIAS_POWER},

    {"RECHARGE_FROM_DEVICE", EFFECT_RECHARGE_FROM_DEVICE, 35, 500,  3, BIAS_MAGE | BIAS_DEMON},
    {"RECHARGE_FROM_PLAYER", EFFECT_RECHARGE_FROM_PLAYER, 90, 500, 16, BIAS_MAGE | BIAS_DEMON | BIAS_POWER},
    ...
    {"LIST_UNIQUES",    EFFECT_LIST_UNIQUES,        80, 250,  8, BIAS_POWER},
    {"LIST_ARTIFACTS",  EFFECT_LIST_ARTIFACTS,      80, 250,  8, BIAS_POWER},
    {"BANISH_EVIL",     EFFECT_BANISH_EVIL,         50, 100,  4, BIAS_PRIESTLY | BIAS_LAW | BIAS_POWER},
    {"BANISH_ALL",      EFFECT_BANISH_ALL,          50, 100,  8, BIAS_MAGE | BIAS_POWER},
    ...
    {"GENOCIDE_ONE",    EFFECT_GENOCIDE_ONE,        60, 250,  8, BIAS_NECROMANTIC | BIAS_POWER},

    /* Timed Buffs:                                 Lv    T   R  Bias */
    {"STONE_SKIN",      EFFECT_STONE_SKIN,          25, 150,  2, BIAS_WARRIOR | BIAS_PROTECTION | BIAS_POWER},
    ...
    {"RESISTANCE",      EFFECT_RESISTANCE,          35, 200,  4, BIAS_RANGER | BIAS_PROTECTION | BIAS_POWER},
    ...
    {"SPEED",           EFFECT_SPEED,               25, 150,  4, BIAS_ROGUE | BIAS_MAGE | BIAS_ARCHER | BIAS_POWER},
    {"SPEED_HERO",      EFFECT_SPEED_HERO,          35, 200,  6, BIAS_WARRIOR | BIAS_POWER},
    {"SPEED_HERO_BLESS",EFFECT_SPEED_HERO_BLESS,    40, 250,  8, BIAS_POWER},
    {"LIGHT_SPEED",     EFFECT_LIGHT_SPEED,         99, 999, 99, BIAS_POWER},
    {"ENLARGE_WEAPON",  EFFECT_ENLARGE_WEAPON,      80, 900,  0, 0},
    {"TELEPATHY",       EFFECT_TELEPATHY,           30, 150,  8, BIAS_MAGE | BIAS_ARCHER},
    {"WRAITHFORM",      EFFECT_WRAITHFORM,          90, 666, 0, 0},
    {"INVULNERABILITY", EFFECT_INVULNERABILITY,     90, 777, 0, 0},
    ...
    {"SUMMON_CYBERDEMON",EFFECT_SUMMON_CYBERDEMON,  90, 900, 16, BIAS_CHAOS | BIAS_POWER},
    ...
    {"RESTORING",       EFFECT_RESTORING,           70, 800,  3, BIAS_PRIESTLY | BIAS_POWER},
    {"HEAL",            EFFECT_HEAL,                40, 500,  1, BIAS_PRIESTLY},
    {"CURING",          EFFECT_CURING,              45, 200,  1, BIAS_PRIESTLY},
    {"HEAL_CURING",     EFFECT_HEAL_CURING,         60, 900,  4, BIAS_PRIESTLY | BIAS_POWER},
    {"HEAL_CURING_HERO",EFFECT_HEAL_CURING_HERO,    70, 900,  4, BIAS_PRIESTLY | BIAS_POWER},
    {"RESTORE_MANA",    EFFECT_RESTORE_MANA,        80, 900,  8, BIAS_MAGE | BIAS_POWER},
    ...
    {"REMOVE_ALL_CURSE",EFFECT_REMOVE_ALL_CURSE,    70, 500,  4, BIAS_PRIESTLY | BIAS_POWER},
    {"CLARITY",         EFFECT_CLARITY,             20,  15, 12, BIAS_PRIESTLY | BIAS_MAGE},
    {"GREAT_CLARITY",   EFFECT_GREAT_CLARITY,       80,  75, 64, BIAS_PRIESTLY | BIAS_MAGE | BIAS_POWER},
    ...
    {"BOLT_CHAOS",      EFFECT_BOLT_CHAOS,          50, 100,  2, BIAS_CHAOS | BIAS_POWER},
    {"BOLT_DISEN",      EFFECT_BOLT_DISEN,          40,  50,  2, 0},
    {"BOLT_TIME",       EFFECT_BOLT_TIME,           60, 200, 90, BIAS_POWER},
    {"BOLT_WATER",      EFFECT_BOLT_WATER,          55, 150,  4, BIAS_MAGE | BIAS_POWER},
    {"BOLT_MANA",       EFFECT_BOLT_MANA,           50, 100,  4, BIAS_MAGE | BIAS_POWER},
    {"BOLT_ICE",        EFFECT_BOLT_ICE,            50, 100,  4, BIAS_MAGE | BIAS_COLD | BIAS_POWER},
    {"BOLT_PLASMA",     EFFECT_BOLT_PLASMA,         50, 100,  4, BIAS_FIRE | BIAS_POWER},

    /* Offense: Beams                               Lv    T   R  Bias */
    {"BEAM_LITE_WEAK",  EFFECT_BEAM_LITE_WEAK,      10,  20,  1, 0},
    {"BEAM_LITE",       EFFECT_BEAM_LITE,           40, 100,  2, 0},
    {"BEAM_GRAVITY",    EFFECT_BEAM_GRAVITY,        50, 150,  8, BIAS_POWER},
    {"BEAM_DISINTEGRATE",EFFECT_BEAM_DISINTEGRATE,  60, 200, 16, BIAS_POWER},
    ...
    {"BEAM_CHAOS",      EFFECT_BEAM_CHAOS,          55, 100,  3, BIAS_CHAOS | BIAS_POWER},
    ...
    {"BALL_LITE",       EFFECT_BALL_LITE,           65, 100,  2, BIAS_POWER},
    {"BALL_DARK",       EFFECT_BALL_DARK,           66, 100,  2, BIAS_NECROMANTIC | BIAS_POWER},
    ...
    {"BALL_CHAOS",      EFFECT_BALL_CHAOS,          65, 150,  4, BIAS_CHAOS | BIAS_POWER},
    {"BALL_DISEN",      EFFECT_BALL_DISEN,          55, 100,  2, 0},
    {"BALL_TIME",       EFFECT_BALL_TIME,           80, 250, 32, BIAS_POWER},
    {"BALL_WATER",      EFFECT_BALL_WATER,          70, 200,  4, BIAS_MAGE | BIAS_POWER},
    {"BALL_MANA",       EFFECT_BALL_MANA,           80, 200,  6, BIAS_MAGE | BIAS_POWER},
    {"BALL_DISINTEGRATE", EFFECT_BALL_DISINTEGRATE, 60, 200, 16, BIAS_POWER},
    ...
    {"BREATHE_CHAOS",   EFFECT_BREATHE_CHAOS,       75, 250,  4, BIAS_CHAOS | BIAS_POWER},
    {"BREATHE_DISEN",   EFFECT_BREATHE_DISEN,       60, 150,  8, 0},
    {"BREATHE_TIME",    EFFECT_BREATHE_TIME,        90, 500, 32, BIAS_POWER},
    ...
    {"DRAIN_LIFE",      EFFECT_DRAIN_LIFE,          40, 100,  2, BIAS_NECROMANTIC | BIAS_POWER},
    {"STAR_BALL",       EFFECT_STAR_BALL,           80, 900, 64, BIAS_LAW | BIAS_POWER},
    {"ROCKET",          EFFECT_ROCKET,              70, 200,  8, BIAS_DEMON | BIAS_POWER},
    {"MANA_STORM",      EFFECT_MANA_STORM,          80, 250,  8, BIAS_MAGE | BIAS_POWER},
    {"CONFUSING_LITE",  EFFECT_CONFUSING_LITE,      60, 100,  6, BIAS_CHAOS | BIAS_POWER},
    {"ARROW",           EFFECT_ARROW,               30, 100,  2, BIAS_RANGER | BIAS_ARCHER},
    {"WRATH_OF_GOD",    EFFECT_WRATH_OF_GOD,        80, 250, 32, BIAS_LAW | BIAS_POWER},
    {"METEOR",          EFFECT_METEOR,              55, 150,  8, 0},
    {"HOLINESS",        EFFECT_HOLINESS,            50, 250,  8, BIAS_PRIESTLY | BIAS_LAW | BIAS_POWER},
    {"STARBURST",       EFFECT_STARBURST,           70, 500, 32, BIAS_LAW | BIAS_POWER},
    {"DARKNESS_STORM",  EFFECT_DARKNESS_STORM,      70, 500, 32, BIAS_NECROMANTIC | BIAS_POWER},
    {"PESTICIDE",       EFFECT_PESTICIDE,           10,   5,  8, 0},

    /* Misc                                         Lv    T   R  Bias */
    {"POLY_SELF",       EFFECT_POLY_SELF,           20, 500,  1, BIAS_CHAOS | BIAS_POWER},
    ...
    {"STASIS_MONSTERS", EFFECT_STASIS_MONSTERS,     50, 250,  8, BIAS_MAGE | BIAS_POWER},
    ...
    {"AGGRAVATE",       EFFECT_AGGRAVATE,           10, 100,  0, 0},
...
bool effect_add_random(object_type *o_ptr, int bias)
{
    ...
    if (i >= 0 && ((_effect_info[i].bias & BIAS_POWER) || p_ptr->prace == RACE_MON_RING))
    {
        _add_index(o_ptr, i);
        return TRUE;
    }
